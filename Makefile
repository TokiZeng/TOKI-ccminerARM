...
ACLOCAL = ${SHELL} /root/TOKI-ccminerARM/missing aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /root/TOKI-ccminerARM/missing autoconf
AUTOHEADER = ${SHELL} /root/TOKI-ccminerARM/missing autoheader
AUTOMAKE = ${SHELL} /root/TOKI-ccminerARM/missing automake-1.16
AWK = gawk
CC = clang
CCAS = clang
CCASDEPMODE = depmode=gcc3
CCASFLAGS = --gcc-toolchain=/usr -finline-functions -march=armv8.2-a+crypto -mcpu=cortex-a55 -mtune=cortex-a55 -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize -O3 -ffinite-loops -ffast-math -mfix-cortex-a53-835769 -D_REENTRANT -falign-functions=16 -fomit-frame-pointer -fpic -pthread -flto -fno-stack-protector -fslp-vectorize -fvectorize
CCDEPMODE = depmode=gcc3
CFLAGS = --gcc-toolchain=/usr -finline-functions -march=armv8.2-a+crypto -mcpu=cortex-a55 -mtune=cortex-a55 -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize -O3 -ffinite-loops -ffast-math -mfix-cortex-a53-835769 -D_REENTRANT -falign-functions=16 -fomit-frame-pointer -fpic -pthread -flto -fno-stack-protector -fslp-vectorize -fvectorize
CPP = clang -E
CPPFLAGS = 
CSCOPE = @CSCOPE@
CTAGS = @CTAGS@
...
CXXFLAGS = --gcc-toolchain=/usr -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize -funroll-loops -finline-functions -O3 -ffinite-loops -ffast-math -mfix-cortex-a53-835769 -D_REENTRANT -falign-functions=16 -fomit-frame-pointer -fpic -pthread -flto -fno-stack-protector -fslp-vectorize -fvectorize -march=armv8.2-a+crypto -mcpu=cortex-a55 -mtune=cortex-a55
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
LDFLAGS = -v -Wl,-hugetlbfs-align -fuse-ld=lld
LIBCURL = -lcurl
LIBCURL_CPPFLAGS = 
LIBOBJS = 
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/TOKI-ccminerARM/missing makeinfo
MKDIR_P = /bin/mkdir -p
NVCC = nvcc
NVML_LIBPATH = 
OBJEXT = o
...
PACKAGE = ccminer
PACKAGE_BUGREPORT = 
PACKAGE_NAME = TOKI-ccminer_CPU
PACKAGE_STRING = ccminer_CPU 4.1.1
PACKAGE_TARNAME = ccminer
PACKAGE_URL = https://github.com/TokiZeng/TOKI-ccminerARM
...
WS2_LIBS = 
_libcurl_config = 
abs_builddir = /root/TOKI-ccminerARM
abs_srcdir = /root/TOKI-ccminerARM
abs_top_builddir = /root/TOKI-ccminerARM
abs_top_srcdir = /root/TOKI-ccminerARM
ac_ct_CC = clang
ac_ct_CXX = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/TOKI-ccminerARM/install-sh
...
distclean-generic:
	...
	-rm -f verus/$(DEPDIR)/$(am__dirstamp)
	-rm -f verus/$(am__dirstamp)
